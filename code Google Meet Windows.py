...
button1.pull = digitalio.Pull.UP  # Pulls Up as button connects to GND when pressed
...
print("Windows Google Meet mode Active")
# Commands for Google Meetings on Windows below
